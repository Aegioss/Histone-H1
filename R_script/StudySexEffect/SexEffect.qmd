...
```{r}
writeLines(MusGeneNames$gene_name[match(rownames(rna_WT_UpRegSorted), MusGeneNames$gene_id)], "/home/franck/SCRATCH/fpan/Data/Analysis/GENE_LIST/RNA_STAR_WT_C1vsC2_UPREG.txt")
writeLines(MusGeneNames$gene_name[match(rownames(rna_WT_DownRegSorted), MusGeneNames$gene_id)], "/home/franck/SCRATCH/fpan/Data/Analysis/GENE_LIST/RNA_STAR_WT_C1vsC2_DOWNREG.txt")

writeLines(MusGeneNames$gene_name[match(rownames(rna_LOW_UpRegSorted), MusGeneNames$gene_id)], "/home/franck/SCRATCH/fpan/Data/Analysis/GENE_LIST/RNA_STAR_LOW_C1vsC2_UPREG.txt")
writeLines(MusGeneNames$gene_name[match(rownames(rna_LOW_DownRegSorted), MusGeneNames$gene_id)], "/home/franck/SCRATCH/fpan/Data/Analysis/GENE_LIST/RNA_STAR_LOW_C1vsC2_DOWNREG.txt")

writeLines(MusGeneNames$gene_name[match(rownames(tt_WT_UpRegSorted), MusGeneNames$gene_id)], "/home/franck/SCRATCH/fpan/Data/Analysis/GENE_LIST/TT_BOWTIE_WT_C1vsC2_UPREG.txt")
writeLines(MusGeneNames$gene_name[match(rownames(tt_WT_DownRegSorted), MusGeneNames$gene_id)], "/home/franck/SCRATCH/fpan/Data/Analysis/GENE_LIST/TT_BOWTIE_WT_C1vsC2_DOWNREG.txt")

writeLines(MusGeneNames$gene_name[match(rownames(tt_LOW_UpRegSorted), MusGeneNames$gene_id)], "/home/franck/SCRATCH/fpan/Data/Analysis/GENE_LIST/TT_BOWTIE_LOW_C1vsC2_UPREG.txt")
writeLines(MusGeneNames$gene_name[match(rownames(tt_LOW_DownRegSorted), MusGeneNames$gene_id)], "/home/franck/SCRATCH/fpan/Data/Analysis/GENE_LIST/TT_BOWTIE_LOW_C1vsC2_DOWNREG.txt")
